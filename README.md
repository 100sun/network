...
> A -> B : seq# 963, ack# 615, data 512 bytes, SYN=0, ACK=1, FIN=0 : handshaking 3<br/>
> ============**EST** finished, no more handshaking===============<br/>
> B -> A : seq# 615, ack# 1475, data 154 bytes, SYN=0, ACK=1, FIN=0<br/>
> A -> B : seq# 1475, ack# 1629, data 1 byte, SYN=0, ACK=1, **FIN=1**<br/>
> ===============**FIN_WAIT_1**===============<br/>
